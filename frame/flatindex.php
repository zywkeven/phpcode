...
function Show(message){
   ...
   strHtml+=" <select><option>1</option></select><img src=\"load1.gif\" onclick=\"Close()\"><br>";
...
<select>
<option>skfjs</option>
<option>skfjs2</option>
<option>skfjs3</option>
<option>skfjs4</option>
<option>skfjs5</option>
<option>skfjs6</option>
</select>
<input type='button' value='aksdf' onclick="Show('Please waiting!')">