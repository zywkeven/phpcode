...
##############################
  ...
  $oldmonth=12;
  $oldday=18;
  $today=getdate(mktime(0,0,0,$oldmonth,$oldday,$oldyear));
...
$nowday=date("Y年n月j日 ",mktime(0,0,0,$oldmonth,$oldday,$oldyear))."<br>".$mten[$everymonth[$j][14]].$mtwelve[$everymonth[$j][15]]."年".$nlmon.$nlday;
