...
{   
  ...
  $numleft20=number1imageleft($lengthlarge-$lengthleft,$widthleft,$lengthsmall,$widthsamll,$distance,$image,$color,0,$widthlarge-$widthleft);
     break; 
     
    case 2:
$numleft10=number1imageleft($lengthleft,$widthlarge,$lengthsmall,$widthsamll,$distance,$image,$color,$lengthlarge-$lengthleft,0);
$numleft20=number2imageleft($lengthlarge-$lengthleft,$widthleft,$lengthsmall,$widthsamll,$distance,$image,$color,0,$widthlarge-$widthleft);   
    break;
    case 3: 
   ...
   $numleft20=number1imageleft($lengthlarge-$lengthleft,$widthleft,$lengthsmall,$widthsamll,$distance,$image,$color,0,$widthlarge-$widthleft);
    ...
    case 11:
    $numleft10=number1imageleft($lengthleft,$widthlarge-$widthleft,$lengthsmall,$widthsamll,$distance,$image,$color,$lengthlarge-$lengthleft,0); 
    ...
    break ;
    case 13:
    $numleft10=number2imageleft($lengthleft,$widthlarge-$widthleft,$lengthsmall,$widthsamll,$distance,$image,$color,$lengthlarge-$lengthleft,0); 
    $numleft20=number1imageleft($lengthlarge,$widthleft,$lengthsmall,$widthsamll,$distance,$image,$color,0,$widthlarge-$widthleft);
